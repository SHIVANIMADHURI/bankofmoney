...
<body class= "bg-cover" style="background: url(img/BG1.jpg) ">
  <?php
  include 'navbar.php';
  ?>     <div class="container-fluid">
  <!-- Introduction section -->
        <div class="row intro py-1" style="background-color : #9966FF;">
          <div class="col-sm-12 col-md">
            <div class="heading text-center my-5">
              <h3>Welcome To</h3>
              <h1>BANK OF MONEY</h1>
              <p>Bank Of MONEY(BOM) was formed in 2020.It is a leading private sector bank in the world. <br>
               Bank can also provide financial services such as wealth management, safe deposit,money exchange etc.</p>
            </div>
          </div>
          <div class="col-sm-12 col-md img text-center">
            <img src="img/banklogo.png" class="img-fluid pt-2">
          </div>
        </div>
        <br><br>
  ...
  <!-- Banking section -->
      ...
      <footer class="footer">
        <p> &copy 2021 Bank of MONEY- Made by SHIVANI</p>
      </footer>
